...
function Footer() {
  return (
    <div>
      <div className="max-w-[1260px] mx-auto my-0 flex md:flex-auto justify-around gap-5 mt-36 mb-0  py-4">
        <div className="item-start font-bold  text-gray-700">
          Dine Market
          <p className="item-start font-normal content-around text-wrap mt-3 text-gray-500">
            Small, artisan label that is good for all.
          </p>
          <div className="inline-flex mt-7 text-4xl gap-3 justify-center">
            <FaGithub />
            <FaFacebook />
            <FaLinkedin />
          </div>
        ...
        <div className="item-start font-bold text-gray-700">
          ...
          <p className="item-start font-normal mt-3 text-gray-500">
            Terms & Condtions
          </p>
          <p className="item-start font-normal mt-3 text-gray-500">
            Privacy Policy
      ...
      <div className="mb-2 mt-0">
        {" "}
        <hr className="max-w-[1260px] mx-auto flex md:flex-auto justify-around  border-gray-400" />
        <div className="flex justify-around gap-5 mb-0">
          <div className="item-start font-bold text-gray-500">
            Copyright 2024
